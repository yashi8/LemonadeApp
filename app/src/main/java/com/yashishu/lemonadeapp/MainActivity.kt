package com.yashishu.lemonadeapp

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.yashishu.lemonadeapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateUI() {
        when(counter){
            ...
            1->{
                binding.imgInfo.setImageResource(R.drawable.lemon_squeez)
